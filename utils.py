...
class Open_AI:
    ...
    def request(self, message):
        ...
        answer = client.chat.completions.create(model=self.model,
                                                messages=[{"role": "system",
                                                          "content": "Given a user, as a Recommender System, please provide only the name of the top 50 recommendations."},
