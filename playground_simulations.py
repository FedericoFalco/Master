    ...
    for my_model in models:
        ...
        try:
            ...
            for i in range(0,recommended_items-1):
                ...
                response_to_list.append(str(response[index_start:index_end-1]))
            response_to_list.append(str(response[index_end:]))
            #salvo la risposta come lista in un dizionario
            recommendations[f"{my_model}_{type_prompt}"] = [response_to_list]
        except Exception as e:
            print("Errore durante la richiesta: ",e)

#verifico alcuni oggetti del dizionario
print(recommendations['LLaMa-3.3-70b-versatile_prompt_CoT_0'])
print(recommendations['LLaMa-3.3-70b-versatile_prompt_CoT_1'])
print(recommendations['LLaMa-3.1-70b-versatile_prompt_GK'])
